...
class StockList extends React.Component {
  ...
  async loadData() {
    ...
    const data = await StockList.fetchData(match, search, this.showError);
...
const IssueListWithToast = withToast(StockList);
IssueListWithToast.fetchData = StockList.fetchData;
